...
{
    public sealed partial class FavoriteCommonUIControl : UIControlBase
    {
        public FavoriteCommonUIControl()
        {
            ...
            if (AppEnvironment.IsPhone)
            {
                ...
                this.appBarDownload.Margin = new Thickness(0, -20, -15, 0);
                this.appBarCopy.Margin = new Thickness(0, -20, 82, 0);

                //this.appBarFavorite.Margin = new Thickness(0, -20, 5, 0);
