...
{
    public sealed partial class DownloadListUIControl : UIControlBase
    {
        public DownloadListUIControl()
        {
        ...
        private async void gridEdit_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            if (curElement != null)
            {
                var dmodel = curElement.DataContext as ModelPropertyBase;
                if (dmodel != null)
                {
                    ...
                    {
                        var listView = CommonHelper.Instance.GetCurrentDownloadListView();
                        if (listView != null)
                        {
                            downloadViewModel.DownloadCollection.ForEach(A =>
                            {
                                try
                                {
                                    if (dmodel.id == A.id)
                        ...
                        else
                        {
                            ...
                            if (randomIndex == 0)
                            {
                                this.grid.AnimateAsync(new FadeOutLeftAnimation { Distance = 600, Duration = 0.5 });
                            }
                            else
                            {
                                this.grid.AnimateAsync(new FadeOutRightAnimation { Distance = 600, Duration = 0.5 });
                            }
                            await grid.AnimateAsync(new FlipOutXAnimation() { Centre = 0.5, Duration = 0.5 });
                        }
                        ...
                        if (pastDetailViewModel != null)
                        {
                            ...
                            {
                                pastDetailModel.isAleadyDownload = false;
                            }
                        }
                        #endregion
                        ...
                        if (rankViewModel != null)
                        {
                            ...
                            {
                                rankPerformanceModel.isAleadyDownload = false;
                            }
                            #endregion
                            ...
                            {
                                rankWeekModel.isAleadyDownload = false;
                            }
                            #endregion
                            ...
                            {
                                rankMonthModel.isAleadyDownload = false;
                            }
                            #endregion
                            ...
                            {
                                rankAllModel.isAleadyDownload = false;
                            }
                            #endregion
                        }
                        #endregion
                        ...
                        if (collectionViewModel != null)
                        {
                            ...
                            {
                                collectionModel.isAleadyDownload = false;
                            }
                        }
                        #endregion

                        await DatabaseHelper.Instance.DeleteBySingle(dmodel, true);

                        //将指定条目从收藏数据集合中删除
                        downloadViewModel.DownloadCollection.Remove(dmodel);

                        //删除物理视频
                        await CommonHelper.Instance.DeleteVideos(dmodel);
